...
> [!NOTE]
> This project was built entirely using Claude Code, Anthropic's AI coding agent. While the code has been
> tested and works as intended, it was generated by AI with human oversight and direction rather than written
> from scratch by an experienced developer.
> 
> Use at your own risk. I make no guarantees about the security, reliability, correctness, or fitness for any
> particular purpose of this code. I cannot take responsibility for any issues, bugs, data loss, security
> vulnerabilities, or other problems that may arise from using this software. Please review the code yourself
> before using it in any production or sensitive environment.
